    ...
    <>
      {isMobile ? (
        <div className="flex bg-[#00072330] ">
          <Image src={`/assets/gallery/${img}`} className="p-4" alt="Image" width={150} height={150} quality={100} />
        ...
        <li className="my-2">
          ...
          >
            <Image src="/assets/gallery/playbtn.svg" className="" alt={title} quality={100} width={18} height={18} />
            <h5>{title}</h5>
          </button>
        </li>
      )}
