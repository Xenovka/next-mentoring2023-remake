...
export default function FAQAccordion({ title, content }) {
  ...
  return (
    <div className={`${styles.bg} text-white p-4 my-2 mx-5 group bg-[#172546] transition-all`}>
      ...
      {isActive && <div className="border-t-2 mt-2 pt-2 text-justify transition-all">{content}</div>}
    </div>
  );
}
